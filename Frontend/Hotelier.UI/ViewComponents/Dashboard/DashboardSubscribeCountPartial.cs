using Hotelier.UI.DTOs.FollowerDTOs;
                ...
                Headers =
    {
        ...
        { "X-RapidAPI-Host", "instagram-profile1.p.rapidapi.com" },
            ...
            using (var response = await client.SendAsync(request))
            {
                ...
                ResultInstagramFollowersDTOs resultInstagramFollowersDtos = JsonConvert.DeserializeObject<ResultInstagramFollowersDTOs>(body);
                ...
                Headers =
    {
        ...
        { "X-RapidAPI-Host", "twitter32.p.rapidapi.com" },
            ...
            using (var response2 = await client2.SendAsync(request2))
            {
                ...
                ResultTwitterFollowersDTOs resultTwittterFollowersDto = JsonConvert.DeserializeObject<ResultTwitterFollowersDTOs>(body2);
                ...
                Headers =
    {
        ...
        { "X-RapidAPI-Host", "fresh-linkedin-profile-data.p.rapidapi.com" },
            ...
            using (var response3 = await client3.SendAsync(request3))
            {
                ...
                ResultLinkedinFollowersDTOs resultLinkedinFollowersDto = JsonConvert.DeserializeObject<ResultLinkedinFollowersDTOs>(body3);
